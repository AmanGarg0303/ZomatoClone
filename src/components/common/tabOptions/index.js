    ...
    const tabs = [
        {
            ...
            backdrop: '#FCEEC0',
            inacive_img: 'https://b.zmtcdn.com/data/o2_assets/246bbd71fbba420d5996452be3024d351616150055.png'
        },
        {
            id: 2,
            name: 'Dining Out',
            ...
            backdrop: '#E5F3F3',
            inacive_img: 'https://b.zmtcdn.com/data/o2_assets/78d25215ff4c1299578ed36eefd5f39d1616149985.png'
        },
        {
            id: 3,
            name: 'Nightlife',
            ...
            backdrop: '#EDF4FF',
            inacive_img: 'https://b.zmtcdn.com/data/o2_assets/01040767e4943c398e38e3592bb1ba8a1616150142.png'
        },
                ...
                {tabs.map((tab) => {
                    return (
                        <div onClick={() => setActiveTab(tab.name)}
                            ...
                            <div className='tab-image-container absolute-center cur-po'
                                style={{ backgroundColor: `${activeTab === tab.name ? tab.backdrop : ""}` }}>
                                <img src={activeTab === tab.name ? tab.active_img : tab.inacive_img} className='tab-image' alt={tab.name} />
                            </div>
